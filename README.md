...
Android-виджет для домашнего экрана: крупно показывает процент заряда батареи и статус (заряжается / от батареи).
...
- Цвет текста/иконки в зависимости от уровня заряда (низкий — красный и т.п.).
